export const en = {
  ...
  studio: {
    ...
    subtitle: "Create and edit your own courses — sections and missions.",
    staffOnly: "Available to staff only",
    staffOnlyHint:
      "The Studio is available only to accounts with teacher (staff) rights.",
    backHome: "Back home",
    newCourse: "New course",
    emptyCourses: "You have no courses yet. Create your first one.",
    loadError: "Couldn't load courses.",
    saveError: "Couldn't save. Please try again.",
    counts: { locations: "sections", missions: "missions" },
    active: "Published",
    draft: "Draft",
    open: "Open",
    form: {
      ...
      titlePlaceholder: "e.g. “Python from scratch”",
    ...
    editor: {
      ...
      notFound: "Course not found or you don't have access.",
      settings: "Course settings",
      active: "Published (visible to learners)",
      save: "Save",
      saving: "Saving…",
      saved: "Saved",
      sections: "Sections",
      addSection: "Add section",
      sectionNameRu: "Section title (RU)",
      sectionNameEn: "Section title (EN)",
      noSections: "No sections yet. Add the first one to start filling the course with missions.",
      missions: "Missions",
      addMission: "Add mission",
      missionNameRu: "Mission title (RU)",
      missionNameEn: "Mission title (EN)",
      xp: "XP",
      noMissions: "No missions in this section.",
      add: "Add",
      adding: "Adding…",
      cancel: "Cancel",
      edit: "Edit",
      delete: "Delete",
      confirmDeleteCourseTitle: "Delete course?",
      confirmDeleteCourseMsg:
        "The course and all its sections and missions will be permanently deleted.",
