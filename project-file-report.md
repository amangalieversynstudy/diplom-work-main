...
Этот документ автоматически сгенерирован и описывает файлы репозитория и их назначение. Для каждого файла даётся краткое объяснение и, если есть релевантный код, — краткий разбор ключевых частей.
